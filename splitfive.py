...
distr1UDP_PORT= 52166
cBUFFER_SIZE = 1024

distr2host = socket.gethostname()
distr2UDP_PORT= 52266

distr3host = socket.gethostname()
distr3UDP_PORT= 52366

distr4host = socket.gethostname()
distr4UDP_PORT= 52466

distr5host = socket.gethostname()
distr5UDP_PORT= 52566
...
while sorting:
    count = 0
    increment = (outer_count-1) *250000
    left = len(hold_lines) - increment
    file_name = "small_file_" + str(outer_count * 250000) + ".txt"
    hold_new_lines = []
    if left < 250000:
        while count < left:
	...
	conn4.connect(('', distr4UDP_PORT))
    	conn4.sendto(file_name,(distr4host,distr4UDP_PORT))
	conn4.sendto(word,(distr4host,distr4UDP_PORT))
    elif i==4:
	conn5.connect(('', distr5UDP_PORT))
    	conn5.sendto(file_name,(distr5host,distr5UDP_PORT))
	conn5.sendto(word,(distr5host,distr5UDP_PORT))
...
c4,addr = conn4.recvfrom(BUFFER_SIZE)
c5,addr = conn5.recvfrom(BUFFER_SIZE)
print (c2)
print (c3)
print (c4)
print (c5)
