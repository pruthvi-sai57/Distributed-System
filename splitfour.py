...
while sorting:
    count = 0
    increment = (outer_count-1) *300000
    left = len(hold_lines) - increment
    file_name = "small_file_" + str(outer_count * 300000) + ".txt"
    hold_new_lines = []
    if left < 300000:
        while count < left:
